...
function performActionBasedOnIndex(index) {
    ...
    switch(index) {
        case 0:
            var filePath = 'main_' + alphabet + '.html'; // 해당 알파벳에 대응하는 HTML 파일 경로
            window.location.href = filePath;
            break;
        case 1:
            var filePath = 'main_' + alphabet+index + '.html'; // 해당 알파벳에 대응하는 HTML 파일 경로
            window.location.href = filePath;
            break;
        default:
            setRecordNumber(0);
            window.location.href = '../05_content/05_content.html';
    }
}
